...
import static com.joker.mmsbackenduserservice.service.Impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    public BaseResponse<Boolean> updateUser(@RequestBody UserUpdateRequest userUpdateRequest,
        ...
        if(userUpdateRequest.getTeamId() != null){
            ...
            ThrowUtils.throwIf(!a, ErrorCode.REQUEST_ERROR,"团队不存在");
        }
    ...
    public BaseResponse<Page<UserVO>> listUserVOByPage(@RequestBody UserQueryRequest userQueryRequest,
        ...
        long size = userQueryRequest.getPageSize();
        // 限制爬虫
        ThrowUtils.throwIf(size > 20, ErrorCode.REQUEST_ERROR);
        Page<User> userPage = userService.page(new Page<>(current, size),
                userService.getQueryWrapper(userQueryRequest));
